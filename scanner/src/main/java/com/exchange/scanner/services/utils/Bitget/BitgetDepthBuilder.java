package com.exchange.scanner.services.utils.Bitget;

import com.exchange.scanner.dto.response.exchangedata.bitget.depth.BitgetDepthData;
...
public class BitgetDepthBuilder {

    public static CoinDepth getCoinDepth(Coin coin, BitgetDepthData data, String exchange) {
