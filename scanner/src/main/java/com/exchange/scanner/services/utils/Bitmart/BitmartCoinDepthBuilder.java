...
import com.exchange.scanner.dto.response.exchangedata.bitmart.depth.BitmartDepthData;
...
public class BitmartCoinDepthBuilder {

    public static CoinDepth getCoinDepth(Coin coin, BitmartDepthData data, String exchange) {
