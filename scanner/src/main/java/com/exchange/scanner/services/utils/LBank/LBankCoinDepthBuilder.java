...
import com.exchange.scanner.dto.response.exchangedata.lbank.depth.LBankDepthData;
...
public class LBankCoinDepthBuilder {

    public static CoinDepth getCoinDepth(Coin coin, LBankDepthData data, String exchange) {
